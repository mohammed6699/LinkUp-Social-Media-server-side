...
import { acceptConnectionRequest, discoverUsers, followUser, 
        getUserConnections, getUserData, getUserProfiles, sendConnectionRequest, 
...
userRouter.get('/recentmessages', protect, getUserRecentMessages)
